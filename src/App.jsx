      ...
      <div className='max-w-2xl mt-12 mx-auto'>
        ...
        <div className='flex items-center space-x-3 justify-center mt-14'>
          <a
            ...
            className='flex items-cente p-2 lg:p-4 text-xs sm:text-sm md:text-base rounded-md space-x-1 shadow-md dark:shadow-none bg-white text-gray-700 hover:bg-gray-100 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600'
          >
